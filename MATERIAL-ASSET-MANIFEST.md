...
| hero-portrait | `a_high_resolution_cutout_portrait_on_a_transparent.png` 1024×1536, true alpha; cropped to mid-torso | `portrait-cutout.webp` 1153×1364, alpha WebP | The approved warm editorial hero portrait, using the existing hero crop and placement | ≤380 kB | Home hero, once | `onError` removes the whole portrait composition while copy remains complete |
