...
Last run: 2026-08-23, against the build of that day.
...
**Result 2026-08-23: 73 passed, 0 failed** with a browser, and **56 passed, 17 skipped, 0 failed** without one.
...
|---|---|---|---|
| `portrait-tanmay` | 3024 × 3780, 4:5 | AVIF and WebP at 480 / 720 / 960 / 1280, JPEG fallback at 960 | Home opening, eager, high priority |
| `practice-handstand-trunk` | 2160 × 3024, 5:7 | AVIF and WebP at 480 / 720 / 1080, JPEG fallback at 720 | Home, real practice proof, lazy |
| `practice-sitting-pine` | 720 × 900, 4:5 | AVIF and WebP at 360 / 480 / 720, JPEG fallback at 480 | Deník, lazy |
| `edge-linen-torn.png` | generated | one alpha mask, 2400 × 1200 | The single organic edge on the site, under the portrait |
| `surface-ink-cotton.webp` | generated | one seamless tile, 1024 × 1024 | The dark bands |

Three real photographs, no video, two generated material assets. Under
the brief's maximum of four photographs, one video and two generated
assets.
...
|---|---|---|---|---|---|---|---|---|---|
| `/` | 1440 | 7 kB | 228 kB | 138 kB | 229 kB | 602 kB | 108 ms | 952 ms | 0.001 |
| `/` | 390 @2× | 7 kB | 228 kB | 138 kB | 288 kB | 661 kB | 80 ms | 900 ms | 0.001 |
| `/praxe` | 1440 | 6 kB | 228 kB | 138 kB | 26 kB | 398 kB | 108 ms | 180 ms | 0.001 |
| `/pribeh` | 390 @2× | 7 kB | 228 kB | 138 kB | 26 kB | 398 kB | 100 ms | 836 ms | 0.001 |
| `/denik` | 390 @2× | 6 kB | 228 kB | 138 kB | 71 kB | 443 kB | 88 ms | 888 ms | 0.001 |
| `/denik/les-nehodnoti` | 390 @2× | 7 kB | 228 kB | 115 kB | 4 kB | 353 kB | 92 ms | 92 ms | 0.003 |
| `/en/` | 1440 | 7 kB | 228 kB | 135 kB | 229 kB | 599 kB | 116 ms | 956 ms | 0.002 |

JS is 89 kB of site plus 142 kB of React, split so that a content edit
