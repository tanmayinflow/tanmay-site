...
test('all 327 original shared files remain exact except precisely authorized copy, M10 runtime and approved prepaid-period deltas',()=>{
  ...
  for(const r of entries){
    if(r.path===pricingDelta.path){
      verifyAuthorizedPricingBytes(readFileSync(join(site,r.path)),r.sha256);
      continue;
    }
