...
import DesktopStory from "./desktop/DesktopStory";
import DesktopMeaningMore from "./desktop/DesktopMeaningMore";
import { DesktopPracticeDiagram, DesktopPracticeCopy, DesktopPracticeHeroArt } from "./desktop/DesktopPractice";
import DesktopCycle from "./desktop/DesktopCycle";
import { useDesktopMotion } from "./desktop/useDesktopMotion";
import {
  ROUTES,
  POSTS,
  MAIL,
  ...
  return <div className="site-page" data-secondary-v6="" data-secondary-v8="" data-secondary-home-edges="">
    ...
    <section className="site-ink page-section practice-anchors" aria-labelledby="p-anchors"><SecondaryHomeInkEdge side="top" />
      <div className="wrap">
        ...
        <div className="practice-anchors-layout"><DesktopPracticeCopy lang={lang}>
        ...
        <DesktopPracticeDiagram lang={lang} /></div>
...
export default function App() {
  ...
  useDesktopMotion(loc.routeId + loc.lang + (loc.postId || ""), !mobile);
