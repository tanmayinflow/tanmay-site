...
export default function MobileCollaborationFaq({ lang }: { lang: string }) {
  ...
  const questions = [
    ...
    ['single', t('Můžu začít jedním tréninkem?', 'Can I start with a single session?'), t('Ano. Jedno setkání může stát samo o sobě. Podíváme se na tvůj pohyb a podle potřeby zařadíme vstupní pohybovou diagnostiku. Odneseš si jasnější obraz o tom, co už funguje, jasné priority a konkrétní další krok.', 'Yes. One session can stand on its own. We look at how you move and, as needed, include an initial movement assessment. You leave with a clearer picture of what already works, clear priorities and a concrete next step.')],
  ];
